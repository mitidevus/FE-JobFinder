                                        ...
                                        <div className="py-10 border-t border-blueGray-200 text-center">
                                            ...
                                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" defaultValue={user?.avatar} placeholder="Put your image URL from web browser here" onChange={(e) => setAvatar(e.target.value)} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                                </div>
                                            </div>
