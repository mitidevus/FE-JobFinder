...
function ThoiGian() {
    ...
    return (
        <React.Fragment>
            <p className="mt-2">
                <span className="font-semibold leading-normal mb-2 text-blueGray-700">Thoi gian:</span>
                {content.thoiGian}
            </p>
            <p className="mt-2">
                <span className="font-semibold leading-normal mb-2 text-blueGray-700">Ngay:</span>
                {content.ngay}
            </p>
            <p className="mt-2">
                <span className="font-semibold leading-normal mb-2 text-blueGray-700">Dia diem:</span>
                {content.diaDiem}
            </p>
        </React.Fragment>
    );
...
function Details() {
    ...
    if (content.status === 1) {
        return (
            <React.Fragment>
                <p className="mt-5">
                    <span className="font-semibold leading-normal mb-2 text-blueGray-700 text-xl">
                        Dear {content.to}
                    </span>
                </p>
    ...
    return (
        <React.Fragment>
            <p className="mt-5">
                <span className="font-semibold leading-normal mb-2 text-blueGray-700 text-xl">Dear {content.to}</span>
            </p>
            <p className="mt-5 mb-5">{content.message}</p>
