                                        ...
                                        {cv.map((cv) => (
                                            ...
                                            >
                                                <p className="font-bold">
                                                    {cv.postId.title} - {cv.postId.userId.companyName}
                                                </p>
                                                {cv.status === 1 && <p>Pending</p>}
                                                {cv.status === 2 && <p>Rejected</p>}
                                                {cv.status === 3 && <p>Approved</p>}
                                                {cv.status === 4 && <p>Invited</p>}
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex flex-col mt-4">
                                            <div className="flex items-center">
                                                ...
                                                <Link
                                                    to={`/profile/${selectedCv.userId._id}`}
