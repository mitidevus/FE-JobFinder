...
function Test() {
    const style = { transform: `translateZ(0px)` }
    return (

        <div class="bg-white-300 antialiasedr">
        <div class="container mx-auto my-60">
            <div>
                ...
                <div class="bg-white relative shadow rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto">
                    ...
                    <div class="mt-16">
                        <h1 class="font-bold text-center text-3xl text-gray-900">Nha tuyen dung A</h1>
                        <p class="text-center text-sm text-gray-400 font-medium">UI Components Factory</p>
                        <p class="text-center text-sm text-gray-400 font-medium">"Email"</p>
                        <p class="text-center text-sm text-gray-400 font-medium">"sdt"</p>
                        <p class="text-center text-sm text-gray-400 font-medium">"Dia chi"</p>
                        <p class="text-center text-sm text-gray-400 font-medium"><strong>Description: </strong>Công ty rất tốt</p>
